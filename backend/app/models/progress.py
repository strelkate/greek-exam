...
from sqlalchemy import Boolean, ForeignKey, Integer, SmallInteger, UniqueConstraint, func, text
...
class UserProgress(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "unit_id", name="uq_user_progress_user_unit"),
    )
    ...
    completed_exercise_ids: Mapped[list[int]] = mapped_column(
